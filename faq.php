    ...
    <div class="page-title">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-6 col-lg-8" style="margin-left: 150px;">
                    <h2 class="extra-margin" style="margin-left : 120px ;">FAQ</h2>
                    <p> Questions and Answers about The PurpleCode </p>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <div class="col-xl-6 col-lg-6">
                                <div class="card">
                                    ...
                                    <div id="collapseOne" class="collapse" data-parent="#accordionExample">
                                        <div class="card-body">
                                                We strongly believe in working with you rather then for you,
                                                so we can fully understand you and your company and deliver creative 
                                                work that really fits your organization's personality. 
                                ...
                                <div class="card">
                                    ...
                                    <div id="collapseTwo" class="collapse" data-parent="#accordionExample">
                                        <div class="card-body">
                                           We first get to understand the business and subject matter
                                           before focusing on every detail.
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-header">
                                        <h5 class="mb-0">
                                            <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                             do we keep maintenance on exsisting products?
                                            </button>
                                        </h5>
                                    </div>
                                    <div id="collapseThree" class="collapse" data-parent="#accordionExample">
                                        <div class="card-body">
                                            Yes .. we do , we offer maintenance services to repair older sites
                                            and give your site a fresh modern look.
                                        </div>
                                    </div>
                                </div>
                               ...
                               <div class="card">
                                    ...
                                    <div id="collapse4" class="collapse" data-parent="#accordionExample">
                                        <div class="card-body">
                                          we help our client define their brand in the world.
                                        </div>
                                    </div>
                                </div>
                            </div>
                           ...
                           <div class="col-xl-6 col-lg-6">
                                <div class="card">
                                    ...
                                    <div id="collapse5" class="collapse" data-parent="#accordionExample">
                                        <div class="card-body">
                                                We provide a clean, sharp , professional website design that 
                                                will adapt to the future growth of your business or organization.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card">
                                    ...
                                    <div id="collapse6" class="collapse" data-parent="#accordionExample">
                                        <div class="card-body">
                                           We combine art in everything we do we aim to give you 
                                           a useful and beautiful thing in days not in months .
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card">
                                    ...
                                    <div id="collapse7" class="collapse" data-parent="#accordionExample">
                                        <div class="card-body">
                                                today, having web persence is no longer an option , a website 
                                                is a vital business tool thats why we provide that tool to 
                                                keep you strong on the business line.
                                        </div>
                                    </div>
                                </div> 
                               ...
                               <div class="card">
                                    ...
                                    <div id="collapse8" class="collapse" data-parent="#accordionExample">
                                        <div class="card-body">
                                                we work in a space where web design is an amazing ,useful 
                                                and valueable thing.
                                        </div>
                                    </div>
                                </div>
